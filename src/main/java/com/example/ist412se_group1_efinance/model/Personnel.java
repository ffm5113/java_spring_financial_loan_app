...
public class Personnel implements Serializable{
    ...
    public void setEmployeeId(String personnelId) { this.employeeId = personnelId;}

    public String getFirstName() { return firstName;}
    public void setFirstName(String personnelFirstName) { this.firstName = personnelFirstName;}

    public String getLastName() { return lastName;}
    public void setLastName(String personnelLastName) { this.lastName = personnelLastName;}
    ...
    public String toString() { // Debugging
        ...
        personnelString += (
                "Personnel ID: " + this.getpId() + "\n" +
                "First Name: " + this.getFirstName() + "\n" +
                        "Last Name: " + this.getLastName() + "\n" +
                        "Email: " + this.getEmail() + "\n"  +
                        "Admin Permissions: " + this.getAdminPermissions() + "\n" +
